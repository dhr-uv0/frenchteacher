...
export const UNITS: UnitMeta[] = [
  ...
  },
  {
    number: 3,
    title: "À l'école",
    subtitle: "School life, opinions, and descriptions",
    color: "violet",
    topics: [
      "School subjects & opinions",
      "Verb avoir (to have)",
      "Articles in negation",
  ...
  },
  {
    number: 4,
    title: "Ma famille",
    subtitle: "Family, descriptions, and possessives",
    color: "orange",
    topics: [
      "Family vocabulary",
...
export const VOCAB_UNIT4: VocabItem[] = [
  // Family members
  { key: "u4_la_famille", french: "la famille", english: "the family", partOfSpeech: "noun", unit: 4, gender: "f" },
  { key: "u4_le_pere", french: "le père", english: "the father", partOfSpeech: "noun", unit: 4, gender: "m" },
  { key: "u4_la_mere", french: "la mère", english: "the mother", partOfSpeech: "noun", unit: 4, gender: "f" },
  { key: "u4_le_frere", french: "le frère", english: "the brother", partOfSpeech: "noun", unit: 4, gender: "m" },
  { key: "u4_la_soeur", french: "la sœur", english: "the sister", partOfSpeech: "noun", unit: 4, gender: "f", tricky: true, audioHint: "sœur = SUR" },
  { key: "u4_le_fils", french: "le fils", english: "the son", partOfSpeech: "noun", unit: 4, gender: "m", tricky: true, audioHint: "FEES" },
  { key: "u4_la_fille", french: "la fille", english: "the daughter / the girl", partOfSpeech: "noun", unit: 4, gender: "f" },
  { key: "u4_le_grand_pere", french: "le grand-père", english: "the grandfather", partOfSpeech: "noun", unit: 4, gender: "m" },
  { key: "u4_la_grand_mere", french: "la grand-mère", english: "the grandmother", partOfSpeech: "noun", unit: 4, gender: "f" },
  { key: "u4_le_cousin", french: "le cousin / la cousine", english: "the cousin", partOfSpeech: "noun", unit: 4 },
  { key: "u4_loncle", french: "l'oncle", english: "the uncle", partOfSpeech: "noun", unit: 4, gender: "m" },
  { key: "u4_la_tante", french: "la tante", english: "the aunt", partOfSpeech: "noun", unit: 4, gender: "f" },
  { key: "u4_le_mari", french: "le mari", english: "the husband", partOfSpeech: "noun", unit: 4, gender: "m" },
  { key: "u4_la_femme", french: "la femme", english: "the wife / the woman", partOfSpeech: "noun", unit: 4, gender: "f" },
  { key: "u4_les_parents", french: "les parents", english: "the parents", partOfSpeech: "noun", unit: 4 },
  // Possessive adjectives
  { key: "u4_mon", french: "mon / ma / mes", english: "my", partOfSpeech: "adjective", unit: 4, tricky: true },
  { key: "u4_ton", french: "ton / ta / tes", english: "your (informal)", partOfSpeech: "adjective", unit: 4 },
  { key: "u4_son", french: "son / sa / ses", english: "his / her / its", partOfSpeech: "adjective", unit: 4, tricky: true },
  { key: "u4_notre", french: "notre / nos", english: "our", partOfSpeech: "adjective", unit: 4 },
  { key: "u4_votre", french: "votre / vos", english: "your (formal/plural)", partOfSpeech: "adjective", unit: 4 },
  { key: "u4_leur", french: "leur / leurs", english: "their", partOfSpeech: "adjective", unit: 4, tricky: true },
  // Physical descriptions
  { key: "u4_les_yeux", french: "les yeux", english: "the eyes", partOfSpeech: "noun", unit: 4 },
  { key: "u4_les_cheveux", french: "les cheveux", english: "the hair", partOfSpeech: "noun", unit: 4, tricky: true },
  { key: "u4_grand", french: "grand / grande", english: "tall / big", partOfSpeech: "adjective", unit: 4 },
  { key: "u4_petit", french: "petit / petite", english: "short / small", partOfSpeech: "adjective", unit: 4 },
  { key: "u4_mince", french: "mince", english: "slim / thin", partOfSpeech: "adjective", unit: 4 },
  { key: "u4_jeune", french: "jeune", english: "young", partOfSpeech: "adjective", unit: 4 },
  { key: "u4_vieux", french: "vieux / vieille / vieil", english: "old", partOfSpeech: "adjective", unit: 4, tricky: true, audioHint: "vieux (m), vieille (f), vieil (m before vowel)" },
  { key: "u4_beau", french: "beau / belle / bel", english: "beautiful / handsome", partOfSpeech: "adjective", unit: 4, tricky: true, audioHint: "beau (m), belle (f), bel (m before vowel)" },
  { key: "u4_nouveau", french: "nouveau / nouvelle / nouvel", english: "new", partOfSpeech: "adjective", unit: 4, tricky: true, audioHint: "Like beau — nouvel before vowel" },
  // Age
  { key: "u4_quel_age", french: "Quel âge as-tu ?", english: "How old are you?", partOfSpeech: "phrase", unit: 4, tricky: true },
  { key: "u4_j_ai_ans", french: "J'ai… ans.", english: "I am… years old.", partOfSpeech: "phrase", unit: 4 },
];
